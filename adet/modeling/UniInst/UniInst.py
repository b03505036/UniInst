...
class UniInst(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.proposal_generator.num_gen_params = self.mask_head.num_gen_params
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            proposals, proposal_losses = self.proposal_generator(
                images, features, gt_instances, self.controller, self.mask_head.cost, mask_feats
            )
