...
_C.MODEL.OYOR = CN()
_C.MODEL.OYOR.MASK_BETA = 0.9
_C.MODEL.OYOR.CENTER_SAMPLING_RADIUS = 1.5
_C.MODEL.OYOR.FILTER_KERNEL_SIZE = 3
_C.MODEL.OYOR.FILTER_TAU = 2
_C.MODEL.OYOR.AUX_ON = None
_C.MODEL.OYOR.AUX_TOPK = 9
_C.MODEL.OYOR.GN = True
_C.MODEL.OYOR.INFERENCE_TH_TEST = 0.05
_C.MODEL.OYOR.SCORE_THRESH_TEST = 0.05
_C.MODEL.OYOR.ASSIGN = 'OYOR'

# Test cfg.
_C.MODEL.OYOR.NMS_PRE = 500
_C.MODEL.OYOR.SCORE_THR = 0.1
_C.MODEL.OYOR.UPDATE_THR = 0.025
_C.MODEL.OYOR.MASK_THR = 0.5
_C.MODEL.OYOR.MAX_PER_IMG = 100
# NMS type: matrix OR mask.
_C.MODEL.OYOR.NMS_TYPE = None

# NMS
_C.MODEL.OYOR.NMS_THRESH_TEST = 0.6
# Matrix NMS kernel type: gaussian OR linear.
_C.MODEL.OYOR.NMS_KERNEL = "gaussian"
_C.MODEL.OYOR.NMS_SIGMA = 2
# _C.MODEL.OYM.USE_DEFORMABLE = False
_C.MODEL.OYOR.DISABLE_REL_COORDS = False
